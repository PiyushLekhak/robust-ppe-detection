...
OUTPUT_DIR = "runs/evaluation_enhancements"
OUTPUT_CSV = os.path.join(OUTPUT_DIR, "enhancement_results.csv")
...
YOLO_YAML_DIR = "data_enhanced"
RCNN_BASE_DIR = "data_enhanced"
...
def main():
    ...
    for corruption in CORRUPTIONS:
        for severity in SEVERITY_MAP[corruption]:
    ...
    print("\n[Success] Full enhancement report saved to:", OUTPUT_CSV)
